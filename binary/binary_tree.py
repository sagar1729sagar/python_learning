...
class BinaryTree:
    ...
    def add(self, new_node: Node):
        ...
        while current_node:
            if new_node.value == current_node.value:
                raise ValueError("Note with that value already exists")
    ...
    def find(self,value: int):
        ...
        raise LookupError(f'A node with value {value} is not found')
    ...
    #     if value == current_node.value:
    #         raise ValueError(f"The provided node with value {value} is the root of the tree")
    #     while current_node:
    #         if value < current_node.value:
    #             previous_node = current_node
    #             current_node = current_node.left
    ...
    def find_parent(self, value: int) -> Node:
        ...
        while current_node:
            if (current_node.left and current_node.right.value == value) or\
